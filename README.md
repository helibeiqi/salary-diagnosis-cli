...
我在一家芯片制造公司做人力，公司三百多人，日常负责人力成本和人员编制的测算。

芯片厂的人力结构跟普通企业不太一样。产线要连轴转，洁净室里倒班；同一条线上，
正式工、外包、劳务派遣几种用工形态是混在一起的；产线岗位走综合工时制，
工程师走标准工时——光是"这个月实际投了多少工时、其中多少算加班"，
就得从闸机记录里一行行捞出来对。

于是每次测算，都是一张大表打底：正式工的薪酬、外包按单价折算的工时、各类加班，
分头算完再并到一起。领导要动一个参数——某个岗位编制加两个人，或者外包单价调一档——
整张表就得从头再算一遍。**改一版，大半天。**

算得多了就发现，这些数的根子其实在薪酬结构上——每个人落在带宽的什么位置、
是红圈还是绿圈，直接决定了补差要花多少钱、调薪该往哪边倾斜。
结构不清楚，成本测算就是在沙子上盖楼。

所以我除了日常那张成本表，还想要一个能随时看清"现在这批人到底站在哪"的东西。
...
这个仓库就是照这条规矩搭起来的。现在把它开源出来——如果你也在做人力成本、
编制测算或者薪酬诊断，希望它能替你省下一些重复劳动。
...
**目标用户**：在职 HR / 薪酬专员 / 人力成本与编制测算相关岗位，用于内部诊断、
方案推演，以及向候选人或管理层讲解口径与依据。
